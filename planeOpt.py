...
class BaseBullet(object):
    ...
    def __init__(self, x, y, screen, bullet_type):
        ...
        if self.type == 'hero':
            self.x = x + 21
            self.y = y - 20
            self.imagePath = './img/bullet1.png'
        elif self.type == 'enemy':
            self.x = x + 28
            self.y = y + 50
            self.imagePath = './img/bullet0.png'
...
class HeroPlane(BasePlane):
    ...
    def __init__(self, screen):
        ...
        :param screen: 主窗体对象
        """
        super().__init__(screen, './img/hero.png')  # 调用父类的构造方法
        # 飞机默认位置
        self.x = 150
        self.y = 450
        pass
    ...
    def fire(self):
        ...
        """
        # 创建一个新的子弹对象
        new_bullet = BaseBullet(self.x, self.y, self.screen, 'hero')
...
class EnemyPlane(BasePlane):
    ...
    def __init__(self, screen):
        ...
        :param screen: 主窗体对象
        """
        super().__init__(screen, './img/enemy0.png')
        # 飞机默认位置
    ...
    def fire(self):
        ...
        if num == 3:
            # 创建一个新的子弹对象
            new_bullet = BaseBullet(self.x, self.y, self.screen, 'enemy')
            self.bullet_list.append(new_bullet)
        pass
